                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="${contextPath}${sessionScope.SESSION_SYS_USER.imgpath}" alt="Jason's Photo" />
        ...
        <div class="main-container" id="main-container">
            <script type="text/javascript">
				try {
					...
					ace.settings.check('ace-settings-add-container', 'fixed') 
				} catch (e) {
				}
			</script>
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="${contextPath}/home#page/message">
								Home
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="ace-settings-container hidden" id="ace-settings-container">
                        ...
                        <div class="ace-settings-box clearfix" id="ace-settings-box">
                            <div class="pull-left width-50">
                                ...
                                <div class="ace-settings-item">
                                    <input type="checkbox" checked class="ace ace-checkbox-2" id="ace-settings-add-container" />
